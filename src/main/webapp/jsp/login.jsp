...
font {
	...
	<script>
		$(function (){
			...
			$("#img1").click(function () {
				//获取img标签对象
				this.src = "${pageContext.request.contextPath}/checkCodeController?time="+new Date().getTime() ;
			});
		})
	</script>
</head>
...
<div class="container"  style=" width:100%; height:460px; background:#FF2C4C url('${pageContext.request.contextPath}/image/loginbg.jpg') no-repeat;">
<div class="row"> 
	<div class="col-md-7">
	</div>
...
<form class="form-horizontal" action="${pageContext.request.contextPath}/user?method=login" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
		<img src="${pageContext.request.contextPath}/checkCodeController" id="img1"/>
    </div>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="auto_user" value="autoUser"> 自动登录
        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label>
  ...
  <div class="form-group">
    ...
    height:35px;width:100px;color:black;">
    </div>
  </div>
</form>
</div>			
